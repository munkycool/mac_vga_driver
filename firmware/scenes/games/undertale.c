            ...
            if (global_input.action1) {
                ...
                if (menu_select == 0) { // FIGHT
                    ...
                    const char *items[] = {
                        ...
                        "* You ate a Butterscotch Pie.\n* HP fully restored!",
                        "* You ate the Steak in the Shape of\n  Mettaton's Face.\n* HP fully restored!",
                        "* You ate the Glamburger.\n* HP fully restored!",
                        "* You ate a plate of Spaghetti.\n* HP fully restored!",
                        "* You ate the Cum.\n* HP fully restored!",
                        "* You ate a hot dog.\n* HP fully restored!",
                        "* You ate some Mac and Cheese.\n* HP fully restored!",
                        "* You ate a Cinnamon Bunny.\n* HP fully restored!"
                    };
                    int item_idx = get_rand() % 9;
                    strcpy(ut_dialogue, items[item_idx]);
                    ut_char_count = 0;
                    player_hp = 92;
